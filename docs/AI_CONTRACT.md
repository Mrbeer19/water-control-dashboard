...
## ★ สิ่งที่ต้องรู้เรื่องผังน้ำจริง (สำรวจ 12 ก.ย. 2569)

มีผลกับการตีความข้อมูลโดยตรง — อ่านก่อนออกแบบโมเดล

| เรื่อง | ผลต่อโมเดล |
|---|---|
| **ปั๊มหลัก 2 ตัวสลับเวรกันเดิน** ตัวละ 12 ชม. จ่ายให้ทุกโซนเหมือนกัน | ปั๊มที่กำลังพักจะได้ **0 W เป็นช่วงยาว ๆ ทุกวัน** ซึ่งเป็นเรื่องปกติ **ห้ามตรวจว่าปั๊มพัง** · การเทียบประสิทธิภาพต้องเทียบเฉพาะช่วงที่ปั๊มตัวนั้นเข้าเวร |
| **บ่อสำรอง 490,000 L รับน้ำจากประปาโดยตรง** | ช่วงเติมบ่อ มิเตอร์หลักจะพุ่งขึ้นมากโดยที่โซนไม่ได้ใช้น้ำเพิ่ม **ห้ามตีความว่ารั่ว** ต้องหัก Δ ของบ่อออกก่อน |
| **บ่อสูบกลับเข้าถัง 1 ตอนประปาไม่ไหล** | ช่วงนี้ถัง 1 มีน้ำเข้าโดยที่มิเตอร์หลักไม่ขยับ เป็นเรื่องปกติเช่นกัน |
| **ถัง `tank-2` เป็นถังของโซน VIP** | การใช้น้ำโซน VIP ผ่านถังกลาง ไม่ได้จ่ายตรงจากปั๊มหลัก |
| **จำนวนมิเตอร์ยังไม่สรุป** | ห้าม hard-code จำนวนโซนในโมเดลหรือ feature vector |

> **night flow** ที่ใช้ตรวจการรั่วต้องระวังเป็นพิเศษ — ช่วงกลางคืนคือช่วงที่ปั๊มสลับเวรพอดี
> และเป็นช่วงที่ระบบอาจเติมบ่อสำรอง ทั้งสองอย่างทำให้ตัวเลขกลางคืนไม่นิ่ง
