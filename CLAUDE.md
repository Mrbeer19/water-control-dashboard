...
1. รัน `npx tsc --noEmit` ให้ผ่านก่อนเสมอ
2. สรุปสั้น ๆ ว่าเพิ่ม type อะไรใน `lib/types.ts` และเพิ่มฟังก์ชันอะไรใน service layer
3. อย่าเพิ่ง commit จนกว่าจะสั่ง
