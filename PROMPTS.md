...
> ⚠️ **ข้อมูลฮาร์ดแวร์ในไฟล์นี้เป็นของก่อนลงสำรวจหน้างาน (12 ก.ย. 2569) บางจุดไม่ตรงของจริงแล้ว**
> ยึดตาม `CLAUDE.md` และ `HANDOFF.md` เป็นหลัก — ที่ต่างคือ
> ปั๊มหลัก 2 ตัวไม่ได้แบ่งโซนกันแต่สลับเวรกันเดิน · ถัง 2 เป็นถังของโซน VIP ·
> บ่อสำรองรับน้ำจากประปาโดยตรง · จำนวนมิเตอร์ยังไม่สรุป
> (ไม่แก้ไฟล์นี้เพราะเป็นบันทึกคำสั่งที่ใช้ทำจริง — กฎคือของในโค้ดชนะสเปกเสมอ)
